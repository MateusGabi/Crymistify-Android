 ...
 * [AllTodosListFragment.OnListFragmentInteractionListener] interface.
 */
class AllTodosListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_all_todos_list, container, false)
                ...
                viewModel?.getAllTodos()
                        ...
                        ?.subscribe(object : SingleObserver<Collection<Todo>> {
                            override fun onSuccess(value: Collection<Todo>?) {
                                ...
                                adapter = AllTodosViewAdapter(list, listener)
                            }
