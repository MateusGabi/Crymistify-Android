 ...
 * [DonesTodosListFragment.OnListFragmentInteractionListener] interface.
 */
class DonesTodosListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_dones_todos, container, false)
                ...
                viewModel?.getDones()
                        ...
                        ?.subscribe(object : SingleObserver<Collection<Todo>> {
                            override fun onSuccess(value: Collection<Todo>?) {
                                ...
                                adapter = DonesTodosViewAdapter(list, listener)
                            }
